...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description: "Portfolio statistics and GitHub insights for Gyanranjan Patra, a VSSUT Burla graduate. View portfolio views, GitHub activity, and development metrics.",
  keywords: [
                ...
                >
                  ...
                  <CardContent className="pt-0">
                    <div className={`text-3xl font-bold ${data.color}`}>
                      {typeof data.Data === 'number' ? data.Data.toLocaleString() : data.Data}
                    </div>
                  </CardContent>
                </Card>
              );
